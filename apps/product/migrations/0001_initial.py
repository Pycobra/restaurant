    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_percent', models.IntegerField(null=True, verbose_name='Discount percent')),
                ...
                ('product_type', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='vendors_product_type', to='product.producttype')),
